...
i=0
b=len(report_dataset)
print('[')
for lease in report_dataset:
    i=i+1
    print('{"ip_address":"'+format(lease["ip_address"])+'","mac_address":"'+format(lease["hardware"].upper())+'","Expires":"'+format(lease["ends"]-now)+'","Client_Name":"'+format(lease["client-hostname"])+'"}')
    if i < b: print(",")
print(']');
